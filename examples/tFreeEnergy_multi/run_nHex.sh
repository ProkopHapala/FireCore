...
python3 run_ES.py \
    ...
    --system_name "nHexadecan" \
    --nLambda 100 \
    --nMDsteps 2000000 \
    --nEQsteps 5000 \
    --Fconv 1e-6 \
    --constraints "constraints_nHex.txt"
...
echo "----------------------------------------"
python3 plot_TI_interactive.py --input nHexadecan_TI.dat
if [ $? -ne 0 ]; then
...
echo ""
echo "Output files:"
echo "  - nHexadecan_TI.dat (raw data)"
echo "  - nHexadecan_TI_interactive.html (interactive plot)"
echo ""
echo "To view the interactive plot, open nHexadecan_TI_interactive.html in a web browser"
echo ""
