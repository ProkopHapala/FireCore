...
! Dassemble_ca_snxc_on.f90
! Program Description
! ===========================================================================
!       This routine assembles the forces for the Sankey-Niklewski two-center 
...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_ca_snxc_on (nprocs, iordern)
        use charges
        use configuration
...
!      d(<mu i|rho_j|nu i>)/dR  .... rhop_on (in CRYSTAL coord!!)
!      d(arho)/dR               .... arhop_on                    
!      darho = 0.0d0
           n1 = 0
...
! ****************************************************************************
! End loop over iatom and its neighbors - ineigh.
         end do ! end ineigh
        end do ! end iatom
...
! ===========================================================================
        return
      end subroutine Dassemble_ca_snxc_on
