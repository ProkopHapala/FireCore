...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_ca_olsxc_3c (nprocs, iordern, igauss)
        use configuration
...
! Format Statements
! ===========================================================================
100 format (4i6, 4f14.6)
101 format (3f14.6)
102 format (5f14.6)
103 format (4f20.8)
201 format (' rho_av ', 5f18.8)
202 format (' AAAF ', 6f18.8)
203 format (' FFF ', 5f18.8)
204 format (' BBB ', 4f18.8)
        return
