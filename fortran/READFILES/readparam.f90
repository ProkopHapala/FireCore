...
Namelist /option/ iharris, idogs, imcweda, igsn, ivec_3c, i2dlin, &
                                         ...
                                         kptpreference,         &
                                         rescal, xyz2line, &
                                         fdataLocation, verbosity, idebugwrite, timing_verbosity, ntpr, restartxyz,   &
                                         inputxyz
...
!          stop
!         end if ! (itheory .lt. 0 .or. itheory .gt. 3)
...
! ! SECTION OUTPUTS
!         !if (iwrtcdcoefs .gt. 0)  write (*,*) ' Writing out wavefunction coefficients. '
!         !if (iwrtcharges .gt. 0) write (*,*) ' Writing out charges (Lowdin or Mulliken). '
...
!         !if (iwrthampiece .gt. 0)  write (*,*) ' Writing out Hamiltonian matrix elements. '
!         !if (iwrtcomponents .gt. 0)  write (*,*) ' Writing out components of band-structure energy. '
!         !if (iwrtneigh .gt. 0) write (*,*) ' Writing out neighbor map. '
!         !if (iwrtneigh_com .gt. 0)  write (*,*) ' Writing out common neighbor map. '
