...
! Smoother parameters
         ...
         integer norbitals_new   ! Actual total number of orbitals in the Hamiltonian and overlap matrices.

         integer nbands   ! Total number of occupied bands in the solved problem.
...
! Maximum number of shells and derivatives - needed for reading in the data files.
         integer ideriv_max
         integer isorpmax
         integer isorpmax_xc
