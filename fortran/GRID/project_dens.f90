...
! ============= Body
   ...
   X0(:)  = g1(1) + u1x(1)*elvec(1,:) + u1x(2)*elvec(2,:) + u1x(3)*elvec(3,:)   ! evaluate coordinates of the iatom in the grid coords
...
subroutine project_dens_new( ewfaux, f_mul )
   use configuration
   use dimensions
   use interactions
   use neighbor_map
...
! ===========================================================================
   ...
   return
end subroutine project_dens_new
