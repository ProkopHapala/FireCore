...
! Program Declaration
! ===========================================================================
        subroutine doscentrosDipX (interaction, isub, iforce, in1, in2, in3, distance, eps, deps, sx, spx)
        use dimensions
        use interactions
        implicit none
...
! Here interaction must be = 11 (X-dipole)
...
! JIMM: the dimensions here are different for X,Y dipoles
        real, dimension (ME2cDipX_max) :: dslist
        real, dimension (ME2cDipX_max) :: slist
