...
! Program Declaration
! ===========================================================================
        subroutine assemble_ca_3c_dip (nprocs, iordern, igauss)
        use charges
        use configuration
...
!
! JIMM-JOM: we simplify the stn-stuff
...
!
! we will change this and use only one smoother based on the Rnabc distance
!
