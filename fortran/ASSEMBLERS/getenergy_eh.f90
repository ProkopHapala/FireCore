...
! Program Description
! ===========================================================================
!       This routine calculates the total energy for Extended Hubbard
!
! ===========================================================================
...
! Program Declaration
! ===========================================================================
        subroutine getenergy_eh (itime_step)
...
! The energy/cell uii_uee is returned in the calling statment.
     ...
     &                      uiiuee)
         ...
         call assemble_eh_usr (iforce, ioff2c, ehxcc, ehcoolc)
         
         uiiuee = uiiuee + ehxcc + ehcoolc 
...
! formalism, then the double-counting correction term must be different.
        if (itheory_xc .eq. 0) uxcdcc = uxcdcc_hf
        if (itheory_xc .eq. 1) then 
           uxcdcc = uxcdcc_sn
           etotxc_1c = 0.0d0
        endif
        if (itheory_xc .eq. 2) uxcdcc = uxcdcc_ols 
