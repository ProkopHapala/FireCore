...
if __name__ == "__main__":
    ...
    parser.add_argument("--xyz", type=str, default="../../tests/tFitREQ/wb97m_input/H2O-A1_H2O-D1.xyz", help="Input XYZ scan file")
    parser.add_argument("--atypes", type=str, default="../../cpp/common_resources/AtomTypes.dat", help="Atom types parameter file")
