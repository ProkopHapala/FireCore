    ...
    for itr in range(n_iter):
        ...
        for i in range(3):
            ...
            for k in range(inner_iter):
                ...
                x_new = jacobi_iteration(A, b[:, i], x)
...
if __name__ == "__main__":
    ...
    nx, ny = 5, 5
    truss = Truss()
    truss.build_grid_2d(nx=nx, ny=ny, m=1.0, m_end=1000.0, l=1.0, k=1.0, k_diag=1.0)
    bonds, points, masses, ks, fixed, *_ = truss.get_pd_quantities()
