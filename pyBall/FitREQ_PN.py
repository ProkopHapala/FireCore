...
def setModel(ivdW=4, iCoul=1, iHbond=0, Epairs=0, iEpairs=0, kMorse=1.6, Lepairs=0.5, bPN=True, svdW=1.0, sCoul=1.0, sHcorr=1.0, sEpairs=1.0, SRcut=1.0, SR4m=2, SR4n=2):
    return lib.setModel(ivdW, iCoul, iHbond, Epairs, iEpairs, kMorse, Lepairs, bPN, svdW, sCoul, sHcorr, sEpairs, SRcut, SR4m, SR4n)
