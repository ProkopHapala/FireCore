...
unmatched_calls = []
unmatched_defs  = ['allocate_f', 'allocate_h', 'allocate_neigh', 'assemble_h', 'assemble_hartree', 'assemble_s', 'buildspline2_1d', 'buildspline_1d', 'get_info_orbital', 'getenergy', 'getforces', 'getpsi', 'getvna', 'getylm', 'reallocate_2d_iarray', 'setterp_2d', 'test2c']
assemble_1c_vdip = {
...
'Calls'  : ['ASSEMBLERS/getenergy_mcweda.f90']
}
average_ca_rho = {
...
'Calls'  : ['ASSEMBLERS/assemble_S.f90', 'ASSEMBLERS/assemble_mcweda.f90']
}
build_ca_olsxc_on = {
...
cross = {
'Defs'   : ['MATH/cross.f90'],
'Calls'  : ['INTERACTIONS/get_ewald_OMP.f90']
}
dassemble_2c = {
...
dassemble_lr = {
'Defs'   : ['DASSEMBLERS/Dassemble_lr_OMP.f90'],
'Calls'  : ['DASSEMBLERS/getforces_mcweda.f90']
}
dassemble_lr_dip = {
...
'Calls'  : ['ASSEMBLERS/assemble_2c.f90', 'ASSEMBLERS/assemble_2c_S.f90', 'ASSEMBLERS/assemble_ca_2c.f90', 'ASSEMBLERS/assemble_ca_2c_dip.f90', 'ASSEMBLERS/assemble_ca_3c.f90', 'ASSEMBLERS/assemble_ca_3c_dip.f90', 'ASSEMBLERS/assemble_olsxc_off.f90', 'ASSEMBLERS/assemble_sVNL.f90', 'ASSEMBLERS/average_ca_rho.f90', 'ASSEMBLERS/average_rho.f90', 'DASSEMBLERS/Dassemble_2c.f90', 'DASSEMBLERS/Dassemble_ca_2c.f90', 'DASSEMBLERS/Dassemble_ca_2c_dip.f90', 'DASSEMBLERS/Dassemble_ca_olsxc_2c.f90', 'DASSEMBLERS/Dassemble_ca_snxc_2c.f90', 'DASSEMBLERS/Dassemble_olsxc_2c.f90', 'DASSEMBLERS/Dassemble_snxc_2c.f90']
}
deps3center = {
'Defs'   : ['ROTATIONS/deps3center.f90'],
'Calls'  : ['DASSEMBLERS/Dassemble_3c.f90', 'DASSEMBLERS/Dassemble_ca_3c.f90', 'DASSEMBLERS/Dassemble_ca_3c_dip.f90', 'DASSEMBLERS/Dassemble_ca_olsxc_3c.f90', 'DASSEMBLERS/Dassemble_ca_snxc_3c.f90', 'DASSEMBLERS/Dassemble_olsxc_3c.f90', 'DASSEMBLERS/Dassemble_snxc_3c.f90']
}
doscentros = {
'Defs'   : ['INTERACTIONS/doscentros.f90'],
'Calls'  : ['ASSEMBLERS/assemble_2c.f90', 'ASSEMBLERS/assemble_2c_S.f90', 'ASSEMBLERS/assemble_ca_2c.f90', 'ASSEMBLERS/assemble_ca_2c_dip.f90', 'ASSEMBLERS/assemble_olsxc_off.f90', 'ASSEMBLERS/average_ca_rho.f90', 'ASSEMBLERS/average_rho.f90', 'DASSEMBLERS/Dassemble_2c.f90', 'DASSEMBLERS/Dassemble_ca_2c.f90', 'DASSEMBLERS/Dassemble_ca_2c_dip.f90', 'DASSEMBLERS/Dassemble_ca_olsxc_2c.f90', 'DASSEMBLERS/Dassemble_olsxc_2c.f90']
}
doscentrosdipx = {
...
get_atom_indices = {
'Defs'   : ['INTERACTIONS/get_ewald_OMP.f90'],
'Calls'  : ['INTERACTIONS/get_ewald_OMP.f90']
}
get_ewald = {
'Defs'   : ['INTERACTIONS/get_ewald_OMP.f90'],
'Calls'  : ['ASSEMBLERS/assemble_mcweda.f90', 'ASSEMBLERS/getenergy_mcweda.f90']
}
getenergy_mcweda = {
...
'Calls'  : ['ASSEMBLERS/assemble_usr.f90', 'INTERACTIONS/doscentros.f90', 'INTERACTIONS/doscentrosDipX.f90', 'INTERACTIONS/doscentrosDipY.f90', 'INTERACTIONS/doscentrosPP.f90', 'INTERACTIONS/doscentrosS.f90', 'INTERACTIONS/tester2c.f90']
}
interpolate_2d = {
...
'Calls'  : ['ASSEMBLERS/assemble_usr.f90']
}
rotate_fb = {
...
'Calls'  : ['ASSEMBLERS/assemble_olsxc_1c.f90']
}
