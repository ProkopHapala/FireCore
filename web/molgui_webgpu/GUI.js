...
export class GUI {
    ...
    init() {
        ...
        this.createSection(sidebar, 'Geometry', (container) => {
            ...
            const examples = [
                { name: 'H2O', path: '../common_resources/mol/H2O.mol2', fmt: 'mol2' },
                { name: 'NH3', path: '../common_resources/mol/NH3.mol2', fmt: 'mol2' },
                { name: 'CH4', path: '../common_resources/xyz/CH4.xyz', fmt: 'xyz' },
                { name: 'Formaldehyde', path: '../common_resources/mol/formaldehyde.mol2', fmt: 'mol2' },
                { name: 'Formic Acid', path: '../common_resources/mol/formic_acid.mol2', fmt: 'mol2' },
                { name: 'Methanol', path: '../common_resources/mol/methanol.mol2', fmt: 'mol2' },
                { name: 'HCN', path: '../common_resources/mol/HCN.mol2', fmt: 'mol2' },
                { name: 'Benzene', path: '../common_resources/xyz/benzene.mol2', fmt: 'mol2' },
                { name: 'Pyridine', path: '../common_resources/xyz/pyridine.xyz', fmt: 'xyz' },
                { name: 'Pentacene', path: '../common_resources/xyz/pentacene.xyz', fmt: 'xyz' },
                { name: 'PTCDA', path: '../common_resources/xyz/PTCDA.xyz', fmt: 'xyz' },
                { name: 'Porphirin', path: '../common_resources/mol/porphirin.mol2', fmt: 'mol2' },
                { name: 'Thymine', path: '../common_resources/mol/thymine.mol2', fmt: 'mol2' },
                { name: 'Adenine', path: '../common_resources/xyz/adenine.xyz', fmt: 'xyz' },
                { name: 'Cytosine', path: '../common_resources/xyz/citosine.xyz', fmt: 'xyz' },
                { name: 'Uracil', path: '../common_resources/xyz/uracil.xyz', fmt: 'xyz' },
                { name: 'Adamantane', path: '../common_resources/mol/adamantane.mol2', fmt: 'mol2' },
                { name: 'Si10', path: '../common_resources/mol/Si10.mol2', fmt: 'mol2' },
                { name: 'Xylitol', path: '../common_resources/mol/xylitol.mol2', fmt: 'mol2' },
                { name: 'NaCl 1x1 L3', path: '../common_resources/xyz/NaCl_1x1_L3.xyz', fmt: 'xyz' },
...
build_nanocrystal({
    ...
    planeTemplates: ['a111'],
    cif: { path: '../common_resources/crystals/Si-sym.cif', applySymmetry: true, dedupSymmetry: true },
    planeSymC: 6.0,
...
mol.load("../common_resources/xyz/PTCDA.xyz");
mol.move([0, 0, 10]);
mol.move([12, 0, 0]);
...
mol.load("../common_resources/mol/benzene.mol2");
mol.move([0, 0, 8]);
mol.rotate([0, 0, 1], 30.0);
`.trim()
                },
...
molecule.clear();
molecule.load("../common_resources/mol/tetrahedrane.mol2");
...
molecule.clear();
mol.load("../common_resources/xyz/NH3.xyz");
...
`.trim()
        ...
        this.createSection(sidebar, 'System Log', (container) => {
            ...
            const input = GUIutils.num(row, window.VERBOSITY_LEVEL, {
                min: 0, max: 4, step: '1', onchange: (e) => {
