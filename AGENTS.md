...
- **Test on Completion:** Never claim code works unless tests were actually run successfully. Run test immediately after code modification. Do not use "| tail/head" when running the tests, I want to see full stdout. 
