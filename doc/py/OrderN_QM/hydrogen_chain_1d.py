...
def build_hamiltonian(pos, cell_ids, onsite=0.0, decay=1.0, t0=-1.0, wrap_ends=False):
...
if __name__ == "__main__":
    ...
    ap.add_argument("--cell_a",   type=float, default=2.5)
    ap.add_argument("--dimer_distance", type=float, default=0.74)
    ap.add_argument("--onsite",   type=float, default=-5.0)
    ap.add_argument("--decay",    type=float, default=1.2)
    ap.add_argument("--t0",       type=float, default=-1.0)
    ap.add_argument("--s0",       type=float, default=0.2)
    ap.add_argument("--TS_decay_factor", type=float, default=1.5)
    ...
    H = build_hamiltonian(pos, cell_ids, onsite=args.onsite, decay=args.decay, t0=args.t0, wrap_ends=bool(args.wrap_ends))
