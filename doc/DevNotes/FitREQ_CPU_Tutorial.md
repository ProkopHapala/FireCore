...
- __globals__: `fit.setGlobalParams(kMorse=1.6, Lepairs=0.5, softClamp_start=4.0, softClamp_max=6.0)`
...
- __data__: `fit.loadXYZ(fname, bAddEpairs=1, bOutXYZ=0, bEvalOnlyCorrections=False) -> nbatch`
