...
const char *OCLfft_err_code (cl_int err_in){
    switch (err_in) {
        ...
        case CLFFT_BUGCHECK :                 return (char*)"CLFFT_BUGCHECK";
        case CLFFT_NOTIMPLEMENTED:            return (char*)"CLFFT_NOTIMPLEMENTED";
        case CLFFT_TRANSPOSED_NOTIMPLEMENTED: return (char*)"CLFFT_TRANSPOSED_NOTIMPLEMENTED";
        case CLFFT_FILE_NOT_FOUND:            return (char*)"CLFFT_FILE_NOT_FOUND";
        case CLFFT_FILE_CREATE_FAILURE:       return (char*)"CLFFT_FILE_CREATE_FAILURE";
        case CLFFT_VERSION_MISMATCH:          return (char*)"CLFFT_VERSION_MISMATCH";
        case CLFFT_INVALID_PLAN:              return (char*)"CLFFT_INVALID_PLAN";
        case CLFFT_DEVICE_NO_DOUBLE:          return (char*)"CLFFT_DEVICE_NO_DOUBLE";
        case CLFFT_DEVICE_MISMATCH:           return (char*)"CLFFT_DEVICE_MISMATCH";
        case CLFFT_ENDSTATUS:                 return (char*)"CLFFT_ENDSTATUS";
        default:
            return (char*)"UNKNOWN ERROR";
    }
}

void OCLfft_buildProgramFailure( cl_program program, cl_device_id device ){
    size_t log_size;
...
void OCLfft_check_error(cl_int err, const char *operation, char *filename, int line){
    if (err != CL_SUCCESS){
