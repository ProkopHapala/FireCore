...
./$name -m 1000 -x common_resources/polymer-2_new          -dt 0.05      -g common_resources/NaCl_1x1_L2    -Ftol 1e-2   -perframe 200  -iParalel 3   -group  9,20,17,1,9  0,1,7,9,15,17  -bbox -7.5,-7.5,-10.0,17.5,17.5,10.0,1e-3,1e-3,1.0
