...
if __name__ == "__main__":
    ...
    parser.add_argument('--scan-types', nargs='+',choices=['total', 'morse', 'coulomb'], default=['total'], help='Types of scans to run')
    ...
    if not run_types:
        print("Error: No valid scan types specified. Must be one of: 'total', 'morse', 'coulomb'")
        sys.exit(1)
