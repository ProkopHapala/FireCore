...
parser.add_argument('--visualize', '-vis', type=str, default='no',
                    help="makes it possible to visualize the structure if needed, yes (y) or no. Default=no")
...
if args.visualize == 'yes' or args.visualize == 'y':
    #view(adsorbate)
    view(substrate)
