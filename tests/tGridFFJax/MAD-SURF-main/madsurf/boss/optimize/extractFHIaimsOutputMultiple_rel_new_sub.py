...
output_name = "relaxation_opt.extxyz"
...
for output_path in output_files:
    ...
    # Determine the number of geometries in the file
    num_geometries = 0
    ...
    # Loop through geometries in output and save in extxyz format
    for i in range (0, num_geometries):
        output = read_aims_output(output_path, index=i)
        write_extxyz(output_name, images=output, append=True)
