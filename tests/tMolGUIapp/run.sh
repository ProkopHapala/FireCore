...
#./$name -x common_resources/polymer-2_new   -g common_resources/NaCl_1x1_L2   -Ftol 1e-6 -iParalel 0  -dt 0.05 -perframe 100 -gridffmode 2
#./$name -x common_resources/polymer-2_new   -g common_resources/NaCl_1x1_L2   -Ftol 1e-6 -iParalel 0  -dt 0.05 -perframe 100 -gridffmode 1
./$name -x common_resources/polymer-2_new   -g common_resources/NaCl_1x1_L2   -Ftol 1e-6 -iParalel 0  -dt 0.05 -perframe 100 -gridffmode 0
