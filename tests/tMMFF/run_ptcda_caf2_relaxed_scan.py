...
def main():
    ...
    ap.add_argument('--damp', type=float, default=0.05, help='Relaxation damping')
    ap.add_argument('--Fconv', type=float, default=1e-4, help='Force convergence threshold')
    ap.add_argument('--nstep_max', type=int, default=2000, help='Max relaxation steps per scan point')
    ...
    ap.add_argument('--anchor_z_above', type=float, default=4.0, help='Initial anchor height above substrate')
    ...
    ap.add_argument('--nscan', type=int, default=2, help='Number of scan points')
    ap.add_argument('--x0', type=float, default=2.0, help='Scan start x')
    ap.add_argument('--x1', type=float, default=5.0, help='Scan end x')
