...
PLQ_cpu = np.load("./data/NaCl_1x1_L2/Bspline_PLQd_cpu.npy"); print("PLQ_cpu.shape ", PLQ_cpu.shape )
...
plt.plot( PLQ_cpu[ix,iy,:, 0]*PLQH[0] + PLQ_cpu[ix,iy,:, 1]*PLQH[1],        lw=0.5, label="V_Morse CPU" )
plt.plot( PLQ_gpu[ix,iy,:, 0]*PLQH[0] + PLQ_gpu[ix,iy,:, 1]*PLQH[1],        lw=0.5, label="V_Morse GPU" )
plt.plot( (PLQ_gpu[ix,iy,:, 0]*PLQH[0] + PLQ_gpu[ix,iy,:, 1]*PLQH[1])*15.0, lw=0.5, label="V_Morse GPU*15" )
plt.ylim(-1.0,1.0)
