...
namespace MeshBuilder{
    ...
    template<attrib...As>
    constexpr inline void addTriangle(GLvbo<As...>& vbo, Vec3f p1, Vec3f p2, Vec3f p3, Vec3f color=COLOR_WHITE){
        //     p3
        //    / |
        //  p1--p2
    ...
    template<attrib...As>
    constexpr inline void addTriangle(GLvbo<As...>& vbo, Vec3f p1, Vec3f p2, Vec3f p3, Vec3f normal, Vec3f color){
        vbo.template push_back_t<MPOS,MCOLOR,MNORMAL>(p1, color, normal);
        vbo.template push_back_t<MPOS,MCOLOR,MNORMAL>(p2, color, normal);
        vbo.template push_back_t<MPOS,MCOLOR,MNORMAL>(p3, color, normal);
    }
    ...
    template<attrib...As>
    constexpr inline void addQuad(GLvbo<As...>& vbo, Vec3f p1, Vec3f p2, Vec3f p3, Vec3f p4, Vec3f color=COLOR_WHITE){
        //  p4--p3
        //  |  / |
        //  | /  |
        //  p1--p2
    ...
    template<attrib...As>
    constexpr inline void addCube(GLvbo<As...>& vbo, Vec3f p1, Vec3f p2, Vec3f p3, Vec3f p4, Vec3f p5, Vec3f p6, Vec3f p7, Vec3f p8, Vec3f color=COLOR_WHITE){
        //     .8------7
        //   .' |    .'|
        //  4---+--3'  |
        //  |   |  |   |
    ...
    template<attrib...As>
    constexpr inline void addCube(GLvbo<As...>&vbo, Vec3f pMin, Vec3f pMax, Vec3f color=COLOR_WHITE){
        Vec3f p1 = pMin;
    ...
    template<attrib...As>
    constexpr inline void addLine(GLvbo<As...>& vbo, Vec3f p1, Vec3f p2, Vec3f color=COLOR_WHITE){
    ...
    constexpr inline void addCircleAxis(GLvbo<As...>& vbo, int n, Vec3f pos, Vec3f v0, Vec3f normal, float r, Vec3f color=COLOR_WHITE){
        ...
        float dphi = 2*M_PI/n;
        float dca  = std::cos( dphi );
        float dsa  = std::sin( dphi );
