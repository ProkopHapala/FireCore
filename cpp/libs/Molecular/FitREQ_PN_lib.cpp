...
void setup( int imodel, int EvalJ, int WriteJ, int CheckRepulsion, int Regularize, int RegCountWeight, int AddRegError, int Epairs, int BroadcastFDOFs, int UpdateDOFbounds, int EvalOnlyCorrections, int SaveJustElementXYZ, int SoftClamp){
    ...
    _setbool( UpdateDOFbounds );
    _setbool( EvalOnlyCorrections );
    _setbool( SaveJustElementXYZ );
    _setbool( SoftClamp );
    printf( "setup() imodel %i EvalJ %i WriteJ %i CheckRepulsion %i Regularize %i RegCountWeight %i AddRegError %i Epairs %i BroadcastFDOFs %i UpdateDOFbounds %i EvalOnlyCorrections %i SaveJustElementXYZ %i SoftClamp %i \n", 
                     W.imodel, W.bEvalJ, W.bWriteJ, W.bCheckRepulsion, W.bRegularize, W.bRegCountWeight, W.bAddRegError, W.bEpairs, W.bBroadcastFDOFs, W.bUpdateDOFbounds, W.bEvalOnlyCorrections, W.bSaveJustElementXYZ, W.bSoftClamp );
    #undef _setbool
}
