...
void doChecks(){
    ...
    Vec3d f,fE;
    printf("ha  "); checkDeriv3d(getEF_a , ha, 0.001,  fE, f );
    printf("hb  "); checkDeriv3d(getEF_b , hb, 0.001,  fE, f );
    printf("hab "); checkDeriv3d(getEF_ab, hab,0.001,  fE, f );
...
void TestAppMMFFmini::saveScreenshot( int i, const char* fname ){
    //if(makeScreenshot){
        ...
        SDL_enderer = SDL_GetRenderer(window);
        SDL_Surface *sshot = SDL_CreateRGBSurface(0, WIDTH, HEIGHT, 32, 0x00ff0000, 0x0000ff00, 0x000000ff, 0xff000000);
        SDL_RenderReadPixels( NULL, SDL_PIXELFORMAT_ARGB8888, sshot->pixels, sshot->pitch);
        ...
        */
        ...
        for(int itr=0; itr<perFrame; itr++){
            ...
            if(bNonBonded){
                ...
                //E += nff.evalLJQ_pbc( builder.lvec, {1,1,1} );   // IT WILL CRASH when you uncoment this
            }
            ...
            // With Randomness - like thermostat
            //float d = 0.05;
    ...
    switch( event.type ){
        case SDL_KEYDOWN :
            switch( event.key.keysym.sym ){
                ...
                //case SDLK_LEFTBRACKET:  ff.i_=(ff.i_+1)%ff.nang; break;
                //case SDLK_RIGHTBRACKET: ff.i_=(ff.i_+1)%ff.nang; break;
