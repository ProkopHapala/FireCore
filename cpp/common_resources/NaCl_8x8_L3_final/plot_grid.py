...
nacl_dir = os.path.join(data_dir, "NaCl_8x8_L3_final")
new_nacl_dir = os.path.join(data_dir, "NaCl_old")
...
cpu_paul_before = np.load(os.path.join(new_nacl_dir, "V_Paul_gpu_before.npy"))
cpu_lond_before = np.load(os.path.join(new_nacl_dir, "V_Lond_gpu_before.npy"))
cpu_coul_before = np.load(os.path.join(new_nacl_dir, "V_Coul_gpu_before.npy"))
...
cpu_paul_after = np.load(os.path.join(new_nacl_dir, "V_Paul_gpu_after.npy"))
cpu_lond_after = np.load(os.path.join(new_nacl_dir, "V_Lond_gpu_after.npy"))
cpu_coul_after = np.load(os.path.join(new_nacl_dir, "V_Coul_gpu_after.npy"))
