...
__kernel void poissonW(
   ...
   // Print only for a single specific point (e.g., middle of the grid)
    if (ix == nx2 && iy == ny2 && iz == nz2) {
        printf("Representative k-point at grid center (ix=%d,iy=%d,iz=%d): kx=%f, ky=%f, kz=%f\n", 
               ix, iy, iz, kx, ky, kz);
    }
...
__constant int pyopencl_defeat_cache_4fb29988df7f4d91a80d19fb7011f3cc = 0;