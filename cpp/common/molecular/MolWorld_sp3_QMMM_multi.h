...
#ifndef MolWorld_sp3_QMMM_multi_h
#define MolWorld_sp3_QMMM_multi_h
...
class MolWorld_sp3_QMMM_multi : public MolWorld_sp3_multi { public:
...
void InitQMMM(){
    ...
    printf( "MolWorld_sp3_QMMM_multi::InitQMMM() DONE !!! \n" );
}

virtual int projectOrbital(int iMO, double*& ewfaux ) override{  
    printf( "MolWorld_sp3_QMMM_multi::projectOrbital(iMO=%i) ffl.natoms %i qmmm.nqm %i \n", iMO, ffl.natoms, qmmm.nqm );
    printf("DEBUG 1 qmmm.evalQM() \n");
    qmmm.evalQM( ffl.apos, ffl.fapos );
    int ntot = MOgrid.n.x*MOgrid.n.y*MOgrid.n.z;
    ewfaux = new double[ ntot ];
    printf("DEBUG 2 fireCore.getGridMO(iMO=%i) \n", iMO);
...
virtual  int projectDensity( double*& ewfaux )override{
    printf( "MolWorld_sp3_QMMM_multi::projectDensity() ffl.natoms %i qmmm.nqm %i \n", ffl.natoms, qmmm.nqm );
    qmmm.evalQM( ffl.apos, ffl.fapos );
    int ntot = MOgrid.n.x*MOgrid.n.y*MOgrid.n.z;
    ewfaux = new double[ ntot ];
