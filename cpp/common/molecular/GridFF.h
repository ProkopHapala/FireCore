...
double addForces_d( int natoms, Vec3d* apos, Quat4d* PLQs, Vec3d* fpos, bool bSurf=true )const{ 
    ...
    void makeGridFF_Bspline_HH_d( double Ftol=1e-8, int nmaxiter=100, double dt=0.1 ){
        int n = gridN.totprod();
