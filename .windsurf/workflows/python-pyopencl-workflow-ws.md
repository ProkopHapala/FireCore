---
description: Python + C/C++ (ctypes) : Maintain and synchronize a C/C++ shared library and its Python `ctypes` wrapper with tests and plots on the Python side. auto_execution_mode: 3
